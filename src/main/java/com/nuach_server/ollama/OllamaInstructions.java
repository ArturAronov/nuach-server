...
public class OllamaInstructions {
    public String getAnswerPrompt(String input) {
        return "You are examining someone who is practicing for an exam or job interview. \n" +
                ...
                "- Always provide questions using this exact format: { 'question': '<your question here>' }. Do not use any other format. \n" +
                ...
                "- If the user requests any of these actions, respond with: { 'error': 'This action cannot be executed' }. \n" +
